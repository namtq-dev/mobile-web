<div id="banner">
    <div class="banner-item">
        <a href="index.php?page_layout=category&cat_id=1&cat_name=iPhone"><img class="img-fluid" src="images/banner-1.png"></a>
    </div>
    <div class="banner-item">
        <a href="index.php?page_layout=product&prd_id=8"><img class="img-fluid" src="images/banner-2.png"></a>
    </div>
    <div class="banner-item">
